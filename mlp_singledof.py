...
class MLPProjectionFilter(nn.Module):
    ...
    def compute_projection(self, lamda_samples, c_samples_input, c_samples, b_eq):
    ...
    def decoder_function(self, inp_norm, init_state, c_samples_input):
        ...
        # Run optimization
        c_samples, avg_res_fixed_point, avg_res_primal, res_primal_history, res_fixed_point_history = self.compute_projection(
